...
document.getElementById("nikAI").addEventListener('input', async (e) => {
    ...
    if (val.length === 16 && !isProcessing) {
        ...
        try {
            ...
            const isDataBelumAda = document.body.innerText.includes("Data tidak ditemukan"); // Sesuaikan teks notif "belum terdaftar" Anda
            ...
            if (isDataDitemukan) {
                ...
                // Opsional: Otomatis klik "Isi Manual" atau tutup popup jika ingin lanjut
            } else {
